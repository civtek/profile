...
export const Events = () => {
  return (
    ...
    >
      <div className="border-2 border-primary w-full p-32 z-20 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-row items-center justify-center mt-20 gap-20">
          ...
          <div className="flex flex-col gap-10">
            ...
            <Link href="/event-regis">
              <button className="text-white transition-all delay-100 ease-in-out duration-500 bg-dark hover:bg-primary hover:text-black border-2 border-primary font-medium text-lg w-full px-5 py-2.5 text-center">
                Register Now
              </button>
            </Link>
          </div>
