        ...
        <div className="grid sm:grid-cols-3 gap-8 w-full h-full">
          ...
          >
            <div className="flex flex-col p-5 sm:p-0 gap-6 items-center justify-center border-2 h-full border-primary rounded-sm">
              ...
              <p className="text-2xl text-center">Impactful Projects</p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col p-5 sm:p-0 gap-6 items-center justify-center border-2 h-full border-primary rounded-sm">
              ...
              <p className="text-2xl text-center">Community & Events</p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col p-5 sm:p-0 gap-6 items-center justify-center border-2 h-full border-primary rounded-sm">
              ...
              <p className="text-2xl text-center">Tools & Education</p>
            </div>
          </motion.div>
        </div>
      </div>
